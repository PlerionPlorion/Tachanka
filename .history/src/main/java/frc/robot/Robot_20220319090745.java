...
public class Robot extends TimedRobot {
  ...
  public void autonomousPeriodic() {
    ...
    if (timer.get() < 2) {
      tachanka.leftFront.set(ControlMode.PercentOutput, 0.5);
      tachanka.rightFront.set(ControlMode.PercentOutput, 0.5);
      tachanka.leftBack.set(ControlMode.PercentOutput, 0.5);
      tachanka.rightBack.set(ControlMode.PercentOutput, 0.5);
    if (timer.get() > 2) {
