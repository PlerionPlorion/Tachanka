...
public class Shooter {
    ...
    public Vector getTargetPosition () {
        ...
        Vector targetRelTurret = targetRelLimelight.addVector(new Vector(0, limeRadius));
        System.out.println(targetRelLimelight);
        return new Vector(targetRelTurret.getAngle()-turretAngle, targetRelTurret.getMag());
    }
